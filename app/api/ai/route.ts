...
const systemPromptByType: Record<ReportType, string> = {
  medical:
    ...
    "Význam klíčů: oa=osobní anamnéza (Obsahuje přehled nemocí, úrazů a operací, které pacient prodělal od narození do současnosti. Pomáhá odhalit souvislosti mezi minulým a současným zdravotním stavem.), ra=rodinná anamnéza (klíčový přehled závažných onemocnění u pokrevních příbuzných (rodiče, sourozenci, prarodiče) sloužící k určení zdravotních rizik pacienta), pa=pracovní anamnéza (Popisuje současné i minulé zaměstnání pacienta a jeho pracovní podmínky. Pomáhá odhalit zdravotní rizika spojená s profesí nebo pracovním zatížením.), sa=sociální anamnéza (Ukazuje, v jakých sociálních a bytových podmínkách pacient žije. Důležité je, s kým bydlí, zda má pomoc a jaké má zázemí pro péči po propuštění.), fa=farmakologická anamnéza (Udává, jaké léky pacient užívá, v jakých dávkách a jak často. Patří sem i vitaminy, doplňky stravy a bylinné přípravky.), aa=alergologická anamnéza (Zjišťuje, na co je pacient alergický a jaká byla reakce. Může jít o léky, potraviny, jiné alergeny nebo i transfuzní přípravky.), ea=expozice/faktory prostředí, no=nynější onemocnění (Popisuje aktuální problém, kvůli kterému pacient přišel nebo byl přijat do nemocnice. Sleduje začátek obtíží, jejich vývoj, okolnosti vzniku a to, co pacient do té doby udělal.), vf=vitální funkce, subj=subjektivní potíže, obj=objektivní nález, examination=provedená vyšetření, therapy=léčba, diagnosis=diagnóza, icd10=MKN-10 kód. " +
